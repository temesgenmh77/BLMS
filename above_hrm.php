    ...
    <ul class="nav-links">
      ...
      <li>
        <div class="iocn-link">
          ...
          <span class="link_name">Admin Menu</span></a>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="view_applied_list.php">View applicants  </a></li>
          <li><a href="Application_deadline.php">Assign Deadline</a></li>
          <li><a href="announce.php">Announce result</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="account.php">New user</a></li>
