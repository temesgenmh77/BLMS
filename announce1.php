...
//if (!isset($_SESSION)){
  //session_start();
//} 
//if((!isset($_SESSION['fname'])) && (!iseset($_SESSION['username']))){
...
<div id="menu"><?php include_once("menu123.php");?></div>
  ...
  <div class="wrapper">
      ...
      <table class='customers' width='90%' cellpadding='10' border="1">
        <tr><th>S.No</th><th>Staff ID</th> <th>Full name</th> <th>Rank</th><th>Salary</th><th>Comm service</th><th>Aca. Affair</th><th>Loan</th><th>work eff</th><th>Retirement </th><th>Experience</th><th>Result</th></tr>
      <?php
...
$total = $rank_val + $salary_val + $comm_val + $affair_val+ $retire_val + $exp + $loan + $eff_val;    
        echo "<tr><td>".$i."</td><td>".$empid. "</td><td>".
        $name. "</td><td>".
        $rank_val. "</td><td>".
        $salary_val."</td><td>".
        $comm_val."</td><td>".
